...
export type Contract<T extends SwapAsset> = {
    ...
    direction: 'send' | 'receive';
    status: ContractStatus;
    htlc: T extends SwapAsset.NIM ? NimHtlcDetails : T extends SwapAsset.BTC ? BtcHtlcDetails : T extends SwapAsset.BTC_LN ? BtcLnHtlcDetails : T extends SwapAsset.USDC | SwapAsset.USDC_MATIC ? UsdcHtlcDetails : T extends SwapAsset.EUR ? EurHtlcDetails : T extends SwapAsset.CRC ? CrcHtlcDetails : never;
};
